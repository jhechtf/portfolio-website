    ...
    <div className="mx-auto max-w-screen-xl pt-10">
      ...
      <figure className="my-3">
        <blockquote className="border-l-4 text-xl rounded-r-lg border-green-400 pl-5 p-7 bg-gray-100 text-gray-500">
          To find nothing in the infinite is equal parts impressive and
          alarming.
        </blockquote>
      ...
      <p>
        I&apos;m not really sure how this happened. What made you try to go
        here?
      </p>

      <p>
        Well since you&apos;re wandering around aimlessly, mind checkout out
        {' '}<a href="/blog">my articles</a>? I've been told they're the best thing
        since nothing!
      </p>
    </div>
  );
